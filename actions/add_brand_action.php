...
if ($result !== false) {
    echo json_encode(['status' => 'success', 'message' => 'Brand added successfully', 'brand_id' => $result]);
} else {
    echo json_encode(['status' => 'error', 'message' => 'Failed to add brand. Brand may already exist in this category.']);
}