...
if ($result !== false) {
    echo json_encode(['status' => 'success', 'message' => 'Product added successfully', 'product_id' => $result]);
} else {
    echo json_encode(['status' => 'error', 'message' => 'Failed to add product. Please check your input.']);
}